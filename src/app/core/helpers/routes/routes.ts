...
export class routes {
  ...
  public static get student(): string {
    return this.baseUrl + '/dashboard/etudiants';
  }
  public static get studentsadd(): string {
    return this.baseUrl + '/etudiants/ajouter';
  }
  public static get studentsedit(): string {
    return this.baseUrl + '/etudiants/editer';
  }
  public static get studentlist(): string {
    return this.baseUrl + '/etudiants/listes';
  }
  public static get studentview(): string {
    return this.baseUrl + '/etudiants/informations';
  }
